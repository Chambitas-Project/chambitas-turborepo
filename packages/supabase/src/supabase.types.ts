...
export type Database = {
  ...
  public: {
    Tables: {
      ...
      ux_usability_telemetry: {
        Row: {
          ...
          test_group: Database["public"]["Enums"]["ab_test_group"] | null
    ...
    Functions: {
      ...
      complete_student_onboarding: {
        Args: {
          ...
          p_skill_ids: string[]
          p_test_group?: Database["public"]["Enums"]["ab_test_group"]
      ...
      evaluate_single_match: {
        Args: { p_project_id: string; p_student_id: string }
        Returns: number
      }
      match_projects_for_student:
      | {
        Args: {
          match_limit: number
    ...
    Enums: {
      ab_test_group: "CONTROL" | "EXPERIMENTAL"
      application_status:
      | "pending_scoring"
      | "pending"
      | "reviewing"
