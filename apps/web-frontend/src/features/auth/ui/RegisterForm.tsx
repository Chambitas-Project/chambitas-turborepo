  ...
  return (
    <div className="w-full max-w-100 space-y-8">
      <div className="space-y-2 text-center lg:text-left">
        <h1 className="text-3xl font-black tracking-tight text-slate-900">Crea tu cuenta</h1>
        <p className="text-sm font-bold text-slate-400">Acceso directo con tus credenciales</p>
      </div>
